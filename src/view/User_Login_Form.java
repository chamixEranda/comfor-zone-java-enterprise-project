...
public class User_Login_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/password_24px.png"))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtPwd, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(110, 110, 110)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if (txtUsername.getText().isEmpty() || txtPwd.getPassword().length == 0) {
            JOptionPane.showMessageDialog(null, "All fields should be filled","Empty Fields",JOptionPane.ERROR_MESSAGE);
        }
        
        else{
            String pass = new String(txtPwd.getPassword());
            UserLogin user = new UserLogin(txtUsername.getText(), pass);
            ManageLogin loguser = new ManageLogin(user);
            int i = loguser.Loginuser();
            if (i == 1) {
                JOptionPane.showMessageDialog(null, "User Login Successfully","Login User",JOptionPane.INFORMATION_MESSAGE);
